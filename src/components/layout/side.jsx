        ...
        return (
            <div className="side-ctn" > 
                <NavLink className="side-section active" to="/employees">
                    <img className="side-icon" src={iconCreateBlack} alt="logo-create" width="30" height="30" />
                    <h3>Create employee</h3>
                </NavLink>
                <NavLink className="side-section" to="/employees">
                    <img className="side-icon" src={iconViewGrey} alt="logo-create" width="30" height="30"/>
                    <h3>See employees</h3> 
                </NavLink>
            </div>    
        )  
        ...
        return (
            <div className="side-ctn"> 
                <NavLink className="side-section" to="/home">
                    <img className="side-icon" src={iconCreateGrey} alt="logo-create" width="30" height="30" />
                    <h3>Create employee</h3>
                </NavLink>
                <NavLink className="side-section active" to="/home">
                    <img className="side-icon" src={iconViewBlack} alt="logo-create" width="30" height="30" /> 
                    <h3>See employees</h3> 
                </NavLink>
            </div>    
        )
