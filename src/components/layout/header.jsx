    ...
    const createHeader = () => {
        return (
            <div className="header-ctn"> 
                ...
                <img className="logo-create" src={logoCreate} alt="logo-create" width="40" height="40" />
            </div>    
        )  
    }
    const viewHeader = () => {
        return (
            <div className="header-ctn"> 
                ...
                <img className="logo-create" src={logoView} alt="logo-view" width="40" height="40" />
            </div>    
        )
    }
    return (
        <section className="header">
            <section className="logo-ctn">
                ...
                <div><h1>Health Wealth </h1><h1>HRnet</h1></div>
            </section>
